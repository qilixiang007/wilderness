...
export default {
	...
	common: {
		...
		sources: 'Sources',
		retrievalDegradedHint: 'The knowledge base search is temporarily unavailable — this answer comes from the model alone and has not been verified against the knowledge base.',
	...
	knowledge: {
		...
		uploadHint: 'Up to {max} at a time',
		fileQuota: '{used}/{max} files',
		batchSummary: 'Ingested {succeeded}, failed {failed}',
		batchTooMany: 'Pick at most {max} files at a time — you selected {count}',
		reselect: 'Choose again',
		batchOverQuota: 'This adds {newCount} new files but only {remaining} slots are left — pick fewer or delete some files first',
	...
	ask: {
		...
		shuffleSuggestions: 'Shuffle',
		suggestions: [
			'Which is the largest planet in the solar system?',
			'Why do stars twinkle?',
			'What is dark matter?',
			'How do black holes form?',
			'How are Jupiter\'s and Saturn\'s rings different?',
			'What does a light-year actually measure?',
			'What happens during a supernova?',
			'Roughly how big is the Milky Way?',
			'Is the Moon slowly drifting away from Earth?',
			'How do we find exoplanets?',
			'Is there really water on Mars?',
			'How are stars born and how do they die?',
			'What makes Titan such an unusual moon?',
			'Why do astronomers think Betelgeuse might go supernova soon?',
	...
	favorites: {
		...
		add: '☆ Favorite',
		remove: '★ Favorited',
		empty: 'Nothing favorited yet — go {link} and tap Favorite.',
		emptyLinkText: 'browse objects',
		generatedEmpty: 'No generated bodies favorited yet — go to {link} and create one to favorite.',
		generatedEmptyLinkText: 'Celestial Forge',
